"""Launch DogCalC with a test portal frame pre-loaded."""
import sys, os
...
STD_PATH = os.path.join(os.path.dirname(__file__), "portico_test.std")

app = QApplication(sys.argv)
app.setApplicationName("DogCalC")
window = MainWindow()

# Replace empty document with parsed structure
...
window._update_status(f"Loaded: portico_test.std")

# Load .std text into editor
