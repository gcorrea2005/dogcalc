...
%============================================
Perfil TUBO 70$\times$70$\times$4 mm en acero ASTM A36.
...
\toprule
\tableheadrow
\textbf{Miembro} & \textbf{Tipo} & \textbf{L (m)} & \textbf{Pu (kN)} & \textbf{$\phi$Pn (kN)} & \textbf{Ratio} & \textbf{Estado} \\
\midrule
M16  & CS-comp & 0.90 & $-731.9$ & 302 & \textbf{2.42} & \textcolor{accent}{OVERSTRESS} \\
M17  & CS-comp & 0.90 & $-731.9$ & 302 & 2.42 & \textcolor{accent}{OVERSTRESS} \\
M10  & CS-comp & 0.90 & $-731.9$ & 302 & 2.42 & \textcolor{accent}{OVERSTRESS} \\
M87  & CS-comp & 0.90 & $-731.9$ & 302 & 2.42 & \textcolor{accent}{OVERSTRESS} \\
\rowcolor{tablerow}
M31  & CI-trac & 0.90 & $+730.2$ & 328 & \textbf{2.23} & \textcolor{accent}{OVERSTRESS} \\
M30  & CI-trac & 0.90 & $+729.9$ & 328 & 2.23 & \textcolor{accent}{OVERSTRESS} \\
M106 & CI-trac & 0.90 & $+730.2$ & 328 & 2.23 & \textcolor{accent}{OVERSTRESS} \\
M107 & CI-trac & 0.90 & $+729.9$ & 328 & 2.23 & \textcolor{accent}{OVERSTRESS} \\
\bottomrule
\end{tabular}
\end{center}
...
OK & 142 \\
\rowcolor{tablerow}
SOBREESFORZADOS & \textcolor{accent}{\textbf{52}} \\
Peor compresion & \textbf{2.42} (CS, M16/M17) \\
\rowcolor{tablerow}
Peor traccion & \textbf{2.23} (CI, M31) \\
\bottomrule
\end{tabular}
\end{center}

{\sffamily\small\color{accent}
\textbf{ATENCION:} El perfil TUBO 70$\times$70$\times$4 mm fue dimensionado originalmente
para la cercha Warren sin cargas de transicion. Al incorporar las reacciones de las
cerchas de transicion (ejes B y C), las fuerzas axiales en las cuerdas se incrementaron
de $\sim$150 kN a $\sim$730 kN, superando ampliamente la capacidad del perfil.
Se requiere una seccion mayor para las cuerdas (TUBO 114$\times$5 mm o superior),
mientras que las diagonales y montantes permanecen dentro de capacidad.
}
...
\begin{enumerate}
    ...
    \item \textbf{Cercha Warren 3D con cargas de transicion:} \textcolor{accent}{NO PASA} con TUBO 70$\times$70$\times$4 mm.
          Las cargas de las cerchas de transicion incrementan las fuerzas axiales en las cuerdas
          a $\sim$730 kN (vs $\sim$150 kN originales), resultando en \textbf{52 miembros sobre-esforzados}
          con ratios de hasta \textbf{2.42} (compresion) y \textbf{2.23} (traccion).
          Las diagonales y montantes permanecen dentro de capacidad.
    \item \textbf{Rediseno requerido:} Se necesita una seccion tubular de mayor area para las
          cuerdas del cajon Warren. Opciones recomendadas: TUBO 114$\times$5 mm ($A\approx 1{,}710$ mm$^2$)
          o TUBO 140$\times$6 mm ($A\approx 2{,}520$ mm$^2$).
\end{enumerate}
